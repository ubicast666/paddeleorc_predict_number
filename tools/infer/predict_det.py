...
class TextDetector(object):
    def __init__(self, det_algorithm, det_db_thresh, det_db_box_thresh, det_db_unclip_ratio,
                 ...
                 det_sast_nms_thresh, det_sast_polygon, det_model_dir,use_gpu,gpu_mem,use_tensorrt,use_fp16,max_batch_size,enable_mkldnn):
        # self.args = args
        ...
        if self.det_algorithm == "DB":
            ...
            pre_process_list[0] = {
                'DetResizeForTest': {
                    'resize_long': det_limit_side_len
                }
            }
        ...
        self.predictor, self.input_tensor, self.output_tensors = utility.create_predictor(
            'det', logger,use_gpu,gpu_mem,use_tensorrt,use_fp16,max_batch_size,enable_mkldnn,det_model_dir=det_model_dir)  # paddle.jit.load(args.det_model_dir)
        # self.predictor.eval()
...
if __name__ == "__main__":
    ...
    text_detector = TextDetector(det_algorithm, det_db_thresh, det_db_box_thresh, det_db_unclip_ratio,
                 use_dilation, det_east_score_thresh, det_east_cover_thresh,
                 det_east_nms_thresh, det_limit_side_len, det_sast_score_thresh,
                 det_sast_nms_thresh, det_sast_polygon, det_model_dir,use_gpu,gpu_mem,use_tensorrt,use_fp16,max_batch_size,enable_mkldnn)
    count = 0
