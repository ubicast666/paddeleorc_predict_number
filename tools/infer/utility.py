...
def create_predictor(mode, logger,use_gpu,gpu_mem,use_tensorrt,use_fp16,max_batch_size,enable_mkldnn,det_model_dir=None,cls_model_dir=None,rec_model_dir=None):
    if mode == "det":
    ...
    if use_gpu:
        ...
        if use_tensorrt:
            config.enable_tensorrt_engine(
                ...
                if use_fp16 else inference.PrecisionType.Float32,
