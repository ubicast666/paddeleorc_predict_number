...
class TextRecognizer(object):
    def __init__(self, rec_algorithm,rec_model_dir,rec_image_shape,
         rec_char_type,rec_batch_num,max_text_length,rec_char_dict_path,
         use_space_char,use_gpu,gpu_mem,use_tensorrt,use_fp16,max_batch_size,enable_mkldnn):
        ...
        # print("self.character_type:", self.character_type)
        ...
        self.predictor, self.input_tensor, self.output_tensors = \
            utility.create_predictor('rec', logger,use_gpu,gpu_mem,use_tensorrt,use_fp16,max_batch_size,enable_mkldnn,rec_model_dir=rec_model_dir)
    ...
    def __call__(self, img_list):
        ...
        elapse = 0
        # print(type(img_num),type(batch_num))
...
def main(image_dir, vis_font_path, drop_score, det_algorithm, det_db_thresh, det_db_box_thresh, det_db_unclip_ratio,
    ...
    text_recognizer = TextRecognizer(rec_algorithm,rec_model_dir,rec_image_shape,
         rec_char_type,rec_batch_num,max_text_length,rec_char_dict_path,
         use_space_char,use_gpu,gpu_mem,use_tensorrt,use_fp16,max_batch_size,enable_mkldnn)
